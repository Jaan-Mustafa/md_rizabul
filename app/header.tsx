...
export function Header(){
    return (
      <header className="flex mb-5 md:mb-10 items-center text-black dark:text-gray-900">
        <Logo />
        ...
        <nav className="font-mono text-xs grow justify-end items-center flex gap-1 md:gap-3">
          ...
          <a
            ...
            target="_blank"
            className="inline-flex hover:bg-gray-200 dark:hover:bg-[#9b9999] active:bg-gray-300 dark:active:bg-[#242424] items-center p-2 rounded-sm transition-[background-color] whitespace-nowrap -mr-2"
          >
