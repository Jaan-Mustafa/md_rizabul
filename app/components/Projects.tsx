...
export default function Projects() {
  return (
    <div className="my-5">
      <h2 className="group font-bold text-xl my-8 relative text-gray-900 -100">
        Projects
      </h2>
      
      <div className="my-8">
        <h3 className="font-bold text-lg mb-3 text-gray-900 -100">
          TNP Portal | NextJS | NestJS | TypeScript
        </h3>
        <p className="my-5 text-gray-800 -300">
